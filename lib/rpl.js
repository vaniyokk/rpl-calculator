...
export const calculateRPL = (list) => {
    ...
    for(let item of list) {
        ...
        if(num == item) { // if casting successful - it's operand
            ...
            switch(item) {
                case '+':
                    operands.push(Big(o1).plus(o2).toFixed(9)); 
                    break;
                case '-':
                    operands.push(Big(o1).minus(o2).toFixed(9)); 
                    break;
                case '*':
                    operands.push(Big(o1).times(o2).toFixed(9)); 
                    break;
                case '/':
                    operands.push(Big(o1).div(o2).toFixed(9)); 
                    break;
            }
        }
    }
